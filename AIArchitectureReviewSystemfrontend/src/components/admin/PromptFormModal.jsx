      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
          <h3 style={{ fontSize: '17px', fontWeight: 700, margin: 0, color: 'var(--text-primary)' }}>
            {editingPrompt ? 'Chỉnh sửa Prompt Template' : 'Tạo mới Prompt Template'}
          </h3>
          <button
            onClick={onClose}
        ...
        <form onSubmit={onSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
          <div>
            ...
            <input
              ...
              placeholder="Ví dụ: ReviewSequenceDiagramPrompt, CheckERConsistency"
              value={formData.name}
          ...
          <div>
            ...
            <textarea
              className="input-text"
              rows={10}
              placeholder="Nhập prompt chỉ thị cho AI model..."
          ...
          <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '10px', marginTop: '10px' }}>
            ...
            >
              <Save size={15} />
              <span>{actionLoading ? 'Đang lưu...' : 'Lưu Template'}</span>
            </button>
          </div>
        </form>
      </div>
